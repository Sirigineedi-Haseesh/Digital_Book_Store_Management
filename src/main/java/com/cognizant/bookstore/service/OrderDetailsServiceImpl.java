...
public class OrderDetailsServiceImpl implements OrderDetailsService {
	...
	public List<OrderDetailsDTO> getOrderDetailsByDateRange(LocalDate startDate, LocalDate endDate) {
		...
		if (orderDetails.isEmpty()) {
			throw new NoOrderDetailsFoundException(
					"No orders found between the dates: " + startDate + " and " + endDate);
		}
	...
	public OrderDetailsDTO createOrder(OrderDetailsDTO orderDetailsDTO) {
		...
		orderDetails.setStatus(OrderStatus.PENDING); // Ensure status is set to PENDING
