...
public class BookServiceImpl implements BookService{
	...
	public BookDTO updateBooks(String title, BookDTO bookDTO) {
	    ...
	    if(bookRepository.existsByIsbn(bookDTO.getIsbn())){
	    	throw new DuplicateTitleException("Book With: "+bookDTO.getIsbn()+" Is Aldready In the Application");
	    }
	...
	public BookDTO updateBooksPatch(String title, BookDTO bookDTO) {
		...
		if(bookRepository.existsByIsbn(bookDTO.getIsbn())) {
			throw new DuplicateIsbnException(bookDTO.getIsbn()+"Is Aldready Exists");
		}
